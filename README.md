...
<a href="https://www.ulmod.com/magento-2-smtp-email-extension.html"><img width="205" src="https://www.ulmod.com/media/wysiwyg/um-download-now1.png"></a>

## Key Features

* Deliver emails sent successfully
* Support up to twelve SMTP providers with predefined settings
* Support email logs and debug logs to check all emails history, Infos, and errors
* Ability to view the content of any email sent and delete each email sent
* Configure the SMTP settings from the backend
* Ability to delete emails and debug logs manually or automatically
